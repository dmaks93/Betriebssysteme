...
void processOrder(int workerId) {
    while (true) {
        ...
        notificationsMutex.lock();
        cout << "Worker " << workerId << " has taken order an from customer " << custId << " of " << ordQuantity << " burgers \n";
        notificationsMutex.unlock();
...
int main(int argc, char *argv[]) {
    ...
    cout << amountOfBurgersMade << " Burger" << " / " << elapsedTime.count() << " Seconds \n";
    cout << "Ratio of: " << burgerTimeRatio << "\n";
